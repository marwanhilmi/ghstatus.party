/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4d05d9754093da4e6b7488d71be2fb1c)
...
declare namespace Cloudflare {
  interface GlobalProps {
    ...
    durableNamespaces: 'StatusRoom' | 'DowntimeAgent'
  }
  interface Env {
    AI: Ai
    ENABLE_AGENT: 'true'
    ...
    StatusRoom: DurableObjectNamespace<import('./src/server-entry').StatusRoom>
    DowntimeAgent: DurableObjectNamespace<import('./src/server-entry').DowntimeAgent>
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<Cloudflare.Env, 'ENABLE_AGENT' | 'DATABASE_URL' | 'BETTER_AUTH_URL' | 'BETTER_AUTH_SECRET'>
  > {}
}
